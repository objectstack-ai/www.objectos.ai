---
title: "Vibe-Coding-Schulden: Warum KI-gebaute Apps später schwer zu ändern sind"
description: "Ein KI-gebautes Spesensystem lief monatelang gut. Als sich eine Steuerregel änderte, traute sich niemand an 12.000 ungelesene Codezeilen. Langfristige Systeme brauchen prüfbare Definitionen statt nur generierten Code."
...
Diese paar Dutzend Zeilen sind keine „noch zu implementierende Schnittstelle", **sie sind selbst das System**. Die offene ObjectStack Runtime liest sie und leitet automatisch Datentabellen, APIs, Oberflächen sowie vom Agent aufrufbare governte Werkzeuge ab; Berechtigungen und Genehmigungsflüsse sind ebenfalls Deklarationen, die daran hängen, statt handgeschriebener Logik.
