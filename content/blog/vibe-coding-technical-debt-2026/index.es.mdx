---
title: "Deuda técnica de Vibe Coding: por qué las apps hechas con IA son difíciles de cambiar después"
description: "Un sistema de gastos con IA funcionó meses. Cuando cambió una norma fiscal, nadie se atrevió a tocar código no leído. Los sistemas duraderos necesitan definiciones revisables."
...
3. **La superficie de vulnerabilidad se reduce.** Muchos riesgos del código generado aparecen en autenticación, construcción de consultas y procesamiento de entradas escritos a mano. Cuando de todo eso se encarga el runtime unificado, la capa de aplicación puede introducir muchas menos categorías de vulnerabilidades.
