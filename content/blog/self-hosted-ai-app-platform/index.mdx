...
The key is that the model should not connect directly to the database or hold business-system credentials. It should receive only the minimum approved context through a runtime such as ObjectOS.
