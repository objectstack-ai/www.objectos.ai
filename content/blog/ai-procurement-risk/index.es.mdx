---
title: "Ver antes el riesgo de proveedores: una app de decisión de compras con AI"
description: "Versión localizada desde el artículo en inglés: lenguaje natural, metadatos, capacidades de AI, permisos y auditoría para AI procurement decision app."
...
---
**En resumen:** una app de compras con AI no es solo puntuar proveedores: modela proveedores, calificaciones, cotizaciones, contratos, entregas y riesgo como metadatos, de modo que la AI saca a la luz el riesgo de forma temprana y cada puntuación puede abrirse y explicarse, con la decisión todavía en tus manos.
...
| Object | Role |
| --- | --- |
| `supplier` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `supplier_qualification` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `quotation` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `purchase_order` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `delivery_record` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `quality_issue` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `supplier_risk` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
