---
title: "Votre IA écrit une appli en une demi-heure — mais oserez-vous cliquer sur Merge ?"
description: "L'IA génère désormais une appli fonctionnelle en une demi-heure, CI tout au vert. Sauf que c'est une PR de huit mille lignes que vous n'avez ni écrite ni lue — oserez-vous la merger ? Quand écrire du code s'automatise, le goulot passe de « écrire » à « oser signer »."
...
C'est exactement l'autre face de ce que racontaient [2026, l'année de la dette technique](/fr/blog/vibe-coding-technical-debt-2026/) et [88 % des pilotes échouent](/fr/blog/why-ai-agent-pilots-fail-four-layers/) : le vibe coding permet à tout le monde de générer des applis, mais une fois générées, personne n'ose les mettre en production — parce que personne ne peut les réviser ni s'en porter garant. La seule différence : ces deux articles adoptaient le point de vue de l'entreprise et des décideurs ; celui-ci adopte le vôtre — celui de la personne dont le doigt est suspendu au-dessus du bouton Merge.
...
Premièrement, **tout ne peut pas devenir des métadonnées**. Un nouvel algorithme temps réel, un pipeline de rendu unique, requièrent encore du vrai code, et il faudra encore que quelqu'un prenne sur lui pour faire la review de cette partie — les métadonnées ne vous aideront pas, et vouloir les y forcer ne ferait qu'empirer les choses. Ce qu'elles font bien, c'est ces 90 % de systèmes métier qu'on reconstruit sans cesse en entreprise.
