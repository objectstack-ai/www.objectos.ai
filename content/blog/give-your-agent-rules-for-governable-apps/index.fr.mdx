---
title: "Arrêtez d'apprendre votre stack à l'IA pas à pas — donnez-lui des règles qui génèrent des « applis gouvernables »"
description: "Chaque équipe configure désormais son agent de codage avec un AGENTS.md ou un .cursor/rules, mais neuf règles sur dix ne gèrent que le style du code — elles rendent le résultat « conforme », pas « gouvernable ». Voici pourquoi le fichier de règles de votre agent est votre vraie doc d'architecture."
...
**La conclusion d'abord** : dans un monde où l'IA écrit l'immense majorité du code, le fichier de règles de votre agent (`AGENTS.md`, `.cursor/rules`, `CLAUDE.md`) est votre **vraie documentation d'architecture, celle qui fait effet**. Or la plupart des équipes s'en servent pour gérer l'indentation et la bibliothèque de composants — c'est-à-dire « le joli », pas « l'osable en production ». Bien utilisé, son levier est bien plus grand.
...
Rajouter la gouvernance après coup, c'est l'erreur la plus courante du moment, et aussi la plus chère : on laisse d'abord l'agent générer, puis on revient réviser les permissions, rajouter l'audit, ajouter les approbations — exactement cette reprise de gouvernance dont parlait [l'article sur les 88 % de pilotes qui échouent](/fr/blog/why-ai-agent-pilots-fail-four-layers/), qui représente huit dixièmes de la charge de travail. Une reprise par appli générée — passé à l'échelle, personne ne peut s'offrir cette facture.
