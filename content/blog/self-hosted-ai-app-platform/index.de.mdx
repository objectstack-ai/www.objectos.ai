...
**Kurz gesagt:** Was Sie zuerst selbst hosten sollten, ist nicht zwangsläufig das Modell – es ist die Runtime, die Objekte, Berechtigungen, Tools, Freigaben und Audit hält. Modelle können von außen kommen; die Schicht, die entscheidet, wer was lesen und tun darf und welche Nachweise aufbewahrt werden, gehört auf Ihre eigene Infrastruktur.
...
![Runtime-Grenze einer selbst gehosteten AI-Anwendungsplattform](./self-hosted-runtime-en.svg)
...
Wichtig ist: Das Modell greift nicht direkt auf Datenbanken zu und besitzt keine Geschäftssystem-Zugangsdaten. Es erhält nur den minimalen, freigegebenen Kontext über die quelloffene ObjectStack Runtime. ObjectOS ist die optionale kommerzielle Produktionsplattform und Betriebserfahrung für dieselbe ObjectStack-Anwendung; es ersetzt diese Runtime-Grenze nicht.
...
## ObjectStack Runtime und die optionale ObjectOS-Betriebsschicht

Die quelloffene ObjectStack Runtime beginnt nicht damit, Unternehmensdaten in eine neue Cloud zu verschieben.

Sie wirkt als selbst gehostete Betriebsschicht in Ihrer Infrastruktur: bestehende Systeme verbinden, als Objekte modellieren und Rechte, Workflows, APIs, Audit und Agent-Tools vereinheitlichen.

ObjectOS ist die optionale kommerzielle Produktionsplattform und Betriebserfahrung für dieselbe ObjectStack-Anwendung. Es ergänzt AI-Building im Browser, Deployment, Support und Betrieb, ohne die offene Definition oder die ObjectStack Runtime darunter zu verändern.
