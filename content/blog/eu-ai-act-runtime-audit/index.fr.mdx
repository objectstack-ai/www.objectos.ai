---
title: "EU AI Act applicable en août, proposition CADA : votre runtime d'IA est-il prêt à être audité ?"
description: "L'auditeur s'assoit et ne pose qu'une seule question : sortez-moi le déroulé complet de cette remise du 14 février. Puis la salle se tait. L'EU AI Act s'applique en août, le CADA propose un cadre de souveraineté, mais 78 % des dirigeants n'ont pas confiance dans leur capacité à passer un audit sous 90 jours. Le problème n'est presque jamais le modèle, mais le runtime — et l'auditabilité ne se rattrape pas au dernier trimestre."
...
## Le compte à rebours est réel, et très proche

L'EU AI Act commence à s'appliquer de façon contraignante en août 2026 ; et tout début de ce mois-ci, le 3 juin, l'UE a proposé le Cloud and AI Development Act (CADA), qui définit pour la première fois un cadre de souveraineté à quatre niveaux unifié à l'échelle européenne pour les services cloud et IA. Pour les entreprises présentes en Europe ou servant des clients européens, c'est une affaire de quelques semaines.

Et le chiffre le plus cinglant est celui-ci : les études montrent que **78 % des dirigeants n'ont pas confiance dans leur capacité à passer, sous 90 jours, un audit indépendant de gouvernance de l'IA**. Non par refus de se conformer, mais parce qu'une fois dans cette salle, ils ne sauront pas répondre.
...
C'est pourquoi « déployons l'IA d'abord, on verra la conformité plus tard » est, en 2026, un pari dangereux : vous pariez que l'audit ne posera pas de questions sur les actions qui n'ont pas été enregistrées sur le moment. Une fois la question posée, toutes les décisions de l'IA sur cette période deviennent une page blanche impossible à étayer.
