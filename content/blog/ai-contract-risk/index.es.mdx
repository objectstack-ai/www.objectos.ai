---
title: "¿Puede AI revisar el contrato primero? Una app de riesgo contractual"
description: "Versión localizada desde el artículo en inglés: lenguaje natural, metadatos, capacidades de AI, permisos y auditoría para AI contract risk app."
...
---
**En resumen:** una app de contratos con AI es más que "resumir el contrato": convierte los tipos de contrato, las cláusulas, las obligaciones, las reglas de riesgo, las aprobaciones y la auditoría en metadatos. La AI revisa y señala el riesgo primero; el área legal sigue tomando la decisión.
...
| Object | Role |
| --- | --- |
| `contract` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `contract_party` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `contract_clause` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `contract_risk` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `obligation` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `review_decision` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
