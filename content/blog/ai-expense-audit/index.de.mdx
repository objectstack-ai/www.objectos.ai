---
title: "Spesenprüfung ist mehr als OCR: Eine AI-Finance-App, die Regeln versteht"
description: "Eine lokalisierte Fassung auf Basis des englischen Artikels: natürliche Sprache, Metadaten, AI-Funktionen, Berechtigungen und Audit für AI expense audit app."
...
tags:
  ...
  - Audit
---
**Kurz gesagt:** AI-Spesenprüfung ist mehr als das Auslesen von Belegen – sie macht Spesenrichtlinien, Budgets, Projekte, Freigaben, Anomaliemuster und Audit zu Metadaten, sodass AI gegen die Regeln prüft und erklären kann, warum, statt eine Blackbox-OCR zu sein.
...
| Object | Role |
| --- | --- |
| `expense_claim` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `expense_item` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `invoice` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `expense_policy` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `budget` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `audit_finding` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `approval_decision` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
