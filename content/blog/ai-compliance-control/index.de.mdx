---
title: "Compliance-Prüfung ohne manuelles Policy-Lesen: Eine AI-IKS-App"
description: "Eine lokalisierte Fassung auf Basis des englischen Artikels: natürliche Sprache, Metadaten, AI-Funktionen, Berechtigungen und Audit für AI internal control app."
...
| Object | Role |
| --- | --- |
| `policy_document` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `policy_clause` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `control_item` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `evidence` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `compliance_gap` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `remediation_task` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
| `audit_log` | Kontrolliertes Geschäftsobjekt für UI, API, Workflows, Berechtigungen und AI-Tools. |
