...
description: "Un système de notes de frais bâti avec l'IA a tourné des mois — jusqu'à ce qu'une règle fiscale change et que personne n'ose toucher ses 12 000 lignes de code jamais lues. Pourquoi générer des définitions vaut mieux que du code."
...
**En bref :** Le goulot d'étranglement du code généré par l'IA, ce n'est pas la vitesse d'écriture — c'est que six mois plus tard, plus personne ne sait le lire et il n'y a aucun auteur à qui demander. Faites générer des métadonnées à l'IA plutôt que du code, et la dette ne s'accumule jamais.
