...
description: "Airtable Omni baut aus einem Satz eine echte App — doch Änderungen landen hinter einem Rückgängig-Button statt einem geprüften Diff, und Self-Hosting gibt es nie. Für ein System of Record entscheiden diese Lücken."
...
Und die ehrliche Antwort lautet: Niemand hat es freigegeben, weil es nie einen Freigabeschritt gab. Eine KI hat an einem Dienstag eine Zugriffssteuerungs-Entscheidung getroffen, sie ging sofort live, und der einzige Nachweis, dass überhaupt etwas geschehen ist, ist ein nachträglicher Aktivitätseintrag — falls überhaupt jemand nachschaut. Das ist der ganze Artikel. Alles weiter unten erklärt, warum diese Lücke strukturell ist und kein fehlendes Feature, das Airtable nächstes Quartal nachliefert.

## Die Unterscheidung, die Ihr Auditor bereits nutzt: präventiv vs. detektivisch

Geben wir Airtable zuerst seinen verdienten Respekt, und zwar präzise, denn vage Kritik ist hier wertlos. Omni ist wirklich kein Vibe Coding — die Formulierung von CEO Howie Liu, „aus einer Teilekiste produktionserprobter Komponenten zusammensetzen", ist die richtige Architektur und schlägt das fragile Neugenerieren von Code bei jedem Prompt. Airtable Enterprise hat echte Kontrollen: Enterprise Hub, Audit-Logs (10.000 Events in der UI, mehr per API), Org-Unit- und Super-Admin-Rollen, EKM/DLP und die erweiterten Berechtigungssteuerungen von 2025, die bis auf Feld- und Datensatzebene reichen. Ein ernsthafter Airtable-Admin liest eine faule „hat keine Governance"-These und hört auf, Ihnen zu vertrauen. Schreiben Sie diese also nicht.
...
- Mit einem **präventiven** Gate ist MTUE **konstruktionsbedingt null.** Die grenzüberschreitende Änderung geht nie live; sie wartet am Freigabeschritt. Es gibt kein Offenlegungsfenster.
