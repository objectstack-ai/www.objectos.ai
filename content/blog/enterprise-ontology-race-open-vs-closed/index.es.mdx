...
| **Databricks Unity Catalog** | Business Semantics, GA: vistas de métricas gobernadas y metadatos para agents definidos una sola vez en la capa de datos, con la implementación central abriéndose en Apache Spark | GA en 2026; Business Glossary y Domains en el Data + AI Summit, jun. 2026 |
