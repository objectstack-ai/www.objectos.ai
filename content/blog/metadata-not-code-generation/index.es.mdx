...
El código sigue existiendo, pero ya no es el único lugar donde vive el cambio de negocio. La estructura de negocio debe entrar en la capa de metadatos para poder generarse, entenderse, modificarse, gobernarse y auditarse.
