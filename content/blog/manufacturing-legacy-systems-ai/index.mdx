---
title: "AI for Legacy Manufacturing Systems: Start With Reports and Work Orders"
description: "Manufacturing systems are hard to replace. A practical AI path connects existing systems and starts with reports, work orders, and exception analysis."
...
**The short version:** Manufacturers do not need to replace ERP or MES to adopt AI. Start with two entry points, reports and work orders, layer an AI-readable business structure over legacy systems, and save automation for later. The key to adoption is boundaries, not the model.
