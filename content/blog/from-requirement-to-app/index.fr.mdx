---
title: "D’une exigence à une app opérationnelle avec ObjectStack"
...
**En bref :** parcourez un seul scénario de ticket de réparation et observez comment objets, champs, vues, permissions, actions, workflows, API et outils d’agent proviennent tous d’un même ensemble de métadonnées — toute la différence entre générer une application opérationnelle et déverser du code jetable.
