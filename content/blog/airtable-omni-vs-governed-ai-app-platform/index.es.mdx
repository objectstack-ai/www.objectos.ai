...
description: "Airtable Omni crea una app real desde una frase, pero despliega cambios tras un botón de deshacer, no un diff revisado, y nunca podrás autoalojarlo. Para un sistema de registro, esas brechas deciden la plataforma."
...
Y la respuesta honesta es: nadie lo aprobó, porque nunca hubo un paso de aprobación. Una IA tomó una decisión de control de acceso un martes, entró en producción al instante, y el único registro de que algo ocurrió es una entrada de actividad a posteriori, si a alguien se le ocurre mirar. Ese es todo el artículo. Todo lo que sigue explica por qué esa brecha es estructural, no una función ausente que Airtable lanzará el próximo trimestre.
...
- Con una compuerta **preventiva**, el MTUE es **cero por construcción.** El cambio que cruza la línea nunca entra en producción; espera en el paso de aprobación. No hay ventana de exposición.
