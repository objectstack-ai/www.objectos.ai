...
description: "Lisez statuts, incidents et signaux de retard pour détecter le risque projet plus tôt. L'IA propose, mais changements d'état et alertes passent par validation."
