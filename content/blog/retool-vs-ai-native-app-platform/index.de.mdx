...
Retools Zugriffs-Governance ist wirklich erstklassig, und für eine große Menge von Apps beißt der grep-Test nie zu: ein internes Tool, das von vertrauenswürdigem Personal bedient wird, hinter SSO, gepflegt von denselben Entwicklern, die es geschrieben haben, wo „Support-Leads können bis zu 10.000 $ rückerstatten" an drei Stellen durchgesetzt wird, die zufällig übereinstimmen und sich selten ändern. Dafür — und für die Freiheit, jederzeit in SQL und beliebiges JavaScript abzutauchen, wenn eine Anforderung schräg ist — ist Retool exzellent, und wir werden „ein Tool an einem Nachmittag verdrahten" nicht schlagen.
