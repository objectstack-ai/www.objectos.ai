...
That mislabelling has an individual version too, and the tells are the same ones: [forward deployed engineer vs solutions engineer vs solutions architect vs consultant](/en/blog/forward-deployed-engineer-vs-solutions-architect/) separates the four roles by reporting line and pay mechanic rather than by title, and a utilization target on someone called an FDE is the point at which the conversion has already happened.
