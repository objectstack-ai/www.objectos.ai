---
title: "Les commerciaux ne devraient plus remplir le CRM à la main : un assistant commercial AI"
description: "Version localisée depuis l’article anglais : langage naturel, métadonnées, capacités AI, droits et audit pour AI sales assistant."
...
tags:
  ...
  - Agent
---
**En bref :** un assistant commercial AI n’est pas un simple remplissage automatique greffé sur votre CRM — il génère clients, opportunités, relances, tâches et outils d’agent sous forme de métadonnées gouvernées, de sorte que les commerciaux travaillent par la conversation et que les managers peuvent interroger les données, le tout dans le respect des droits.
...
| Object | Role |
| --- | --- |
| `account` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `contact` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `opportunity` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `sales_activity` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `next_step` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `deal_signal` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
