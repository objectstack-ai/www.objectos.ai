---
title: "El workbench de AI para equipos de contenido: de ideas a retrospectivas"
description: "Versión localizada desde el artículo en inglés: lenguaje natural, metadatos, capacidades de AI, permisos y auditoría para AI content workbench."
...
| Object | Role |
| --- | --- |
| `topic_idea` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `source_material` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `content_brief` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `draft` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `review_task` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `publication` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `content_metric` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
