...
description: "Emballez une base de données en outil MCP et un agent est « branché » en un après-midi ; il exporte alors tous les contrats clients, car cette couche n'a pas d'identité. Le rare : la couche d'outils gouvernée."
