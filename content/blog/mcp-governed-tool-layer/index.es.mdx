...
description: "Envuelve una base de datos como herramienta MCP y un agent queda «conectado» en una tarde; luego exporta los contratos de todos los clientes, porque no tiene identidad. Lo escaso es la capa de herramientas gobernada."
