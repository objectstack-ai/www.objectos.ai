...
**En resumen:** un agente de AI listo para producción debe comportarse como un usuario controlado: heredar la identidad del usuario, aplicar permisos hasta el nivel de objeto, registro, campo y acción, pasar primero por solo lectura antes de actuar, exigir aprobación y reversión en las acciones de alto riesgo y registrar cada paso. ¿Usuario controlado, o administrador oculto?
