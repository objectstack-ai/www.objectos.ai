---
title: "De crear tickets a conversar: un centro de servicios empresariales con AI"
description: "Versión localizada desde el artículo en inglés: lenguaje natural, metadatos, capacidades de AI, permisos y auditoría para AI enterprise service center."
...
tags:
  ...
  - IT service
---
**En resumen:** un centro de servicios para empleados con AI no es convertir los tickets de HR/IT/administración en un chat: son el catálogo de servicios, la base de conocimiento, los objetos de solicitud y los flujos de aprobación como metadatos, de modo que la AI resuelve cosas para los empleados dentro del límite del servicio, no a su margen.
...
| Object | Role |
| --- | --- |
| `service_catalog` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `service_request` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `knowledge_article` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `approval_task` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `fulfillment_task` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
| `employee_profile` | Objeto de negocio gobernado para UI, API, flujos, permisos y herramientas AI. |
