---
title: "Le cœur des applications AI-native n’est pas la génération de code, mais la génération de métadonnées"
description: "La génération de code accélère les prototypes, mais les applications d’entreprise ont besoin d’une runtime de métadonnées où objets, champs, relations, vues, permissions, workflows, actions et outils d’Agent sont gouvernés ensemble."
...
**En bref :** une application AI-native n’est pas un amas de code généré, mais des métadonnées générées — objets, permissions, workflows et outils d’Agent réunis sous une seule runtime gouvernée. Le code s’exécute ; les métadonnées sont ce qui reste modifiable et gouvernable.
