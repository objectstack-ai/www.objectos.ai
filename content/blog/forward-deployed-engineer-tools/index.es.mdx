...
description: "Cinco dolores definen el trabajo forward-deployed: la fontanería devora la semana uno, las demos mueren en la revisión de seguridad, los requisitos cambian más rápido que el código, los patrones no capitalizan y la entrega envenena la confianza."
...
HotCRM es la demostración completa de este vocabulario en uso: 15 objetos, 10 flujos, 10 acciones, 4 dashboards, 2 copilotos de AI, 6 skills, 10 roles, 5 reglas de compartición y 4 idiomas — todas las capas presentes, en unas 17.000 líneas.
...
Para clientes que quieren la plataforma operada, [ObjectOS](https://www.objectos.ai) es el runtime comercial sobre la misma definición abierta — construye y pregunta online, gobernanza incluida.
