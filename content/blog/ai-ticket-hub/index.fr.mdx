---
title: "Quand le support comprend le client : construire un hub de tickets AI"
description: "Version localisée depuis l’article anglais : langage naturel, métadonnées, capacités AI, droits et audit pour AI ticket hub."
...
---
**En bref :** un hub de tickets AI n’est pas une file d’attente dotée d’un chatbot — ce sont des objets, des files, des SLA, une base de connaissances et des outils d’agent sous forme de métadonnées, de sorte que l’AI peut réellement comprendre le problème du client et agir dessus, le tout dans le respect des droits.
...
| Object | Role |
| --- | --- |
| `customer` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `case` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `case_message` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `knowledge_article` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `sla_policy` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `case_escalation` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
