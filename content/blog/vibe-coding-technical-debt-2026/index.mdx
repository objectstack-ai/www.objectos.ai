...
Worth being clear that AI did not invent the pattern, only the speed. Hand-built internal systems have been ossifying this way for decades, and [the five-year ledger for one custom system](/en/blog/why-custom-systems-die/) prices what it costs when the authors are people who have simply moved on. This article is the accelerated case: the same gap, opened in months instead of years, and with nobody to go back and ask at all.
