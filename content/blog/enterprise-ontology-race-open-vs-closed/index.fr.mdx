...
| **Databricks Unity Catalog** | Business Semantics, GA — vues de métriques gouvernées et métadonnées d'agents définies une fois au niveau de la couche de données, l'implémentation centrale étant ouverte dans Apache Spark | GA en 2026 ; Business Glossary et Domains au Data + AI Summit, juin 2026 |
