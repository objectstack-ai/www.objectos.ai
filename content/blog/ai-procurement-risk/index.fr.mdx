---
title: "Voir le risque fournisseur plus tôt : une application AI pour les décisions d’achat"
description: "Version localisée depuis l’article anglais : langage naturel, métadonnées, capacités AI, droits et audit pour AI procurement decision app."
...
---
**En bref :** une application d’achats AI ne se limite pas à noter les fournisseurs — elle modélise les fournisseurs, les qualifications, les devis, les contrats, les livraisons et le risque sous forme de métadonnées, de sorte que l’AI fait remonter le risque tôt et que chaque score peut être ouvert et expliqué, la décision restant la vôtre.
...
| Object | Role |
| --- | --- |
| `supplier` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `supplier_qualification` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `quotation` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `purchase_order` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `delivery_record` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `quality_issue` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
| `supplier_risk` | Objet métier gouverné pour UI, API, workflows, droits et outils AI. |
