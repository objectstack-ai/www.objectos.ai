...
description: "La plupart des CRM contiennent déjà clients, opportunités, contacts et activités. Le bon départ est de laisser l'AI comprendre ces objets sous vos permissions."
...
**En bref :** la bonne façon de mettre l’AI sur votre CRM est de lire d’abord clients, opportunités et notes sous vos permissions, puis de passer de l’analyse en lecture seule aux suggestions, et seulement ensuite à une exécution contrôlée — et non de contourner le CRM avec un outil séparé.
