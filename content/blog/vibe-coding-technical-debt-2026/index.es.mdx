...
description: "Un sistema de gastos hecho con IA funcionó meses, hasta que cambió una norma fiscal y nadie se atrevió a tocar sus más de 10.000 líneas de código sin leer, ni la propia IA. Por qué conviene generar definiciones en vez de código."
...
**En resumen:** el cuello de botella del código generado por IA no es la velocidad a la que se escribe, sino que medio año después nadie puede leerlo y no hay un autor a quien preguntar. Haz que la IA genere metadatos en lugar de código, y la deuda nunca se acumula.
