---
title: "2026, l'année de la dette technique : pourquoi personne n'ose plus toucher aux applis « générées d'une seule phrase » six mois plus tard"
description: "Une équipe a monté un système de notes de frais avec l'IA ; il a tourné sans accroc pendant plus de six mois — jusqu'à ce qu'une règle fiscale change, et que personne n'ose plus toucher aux quelque douze mille lignes de code que personne n'a jamais lues, l'IA qui les a générées étant elle-même d'aucun secours. Cet article décortique pourquoi la dette technique du code généré par IA est une dette particulière, presque impossible à rembourser, et pourquoi faire générer à l'IA des définitions plutôt que du code est la voie de sortie pour les applications d'entreprise."
...
Les chiffres du secteur sont la projection macroscopique de ce mécanisme : début 2026, 85 % des développeurs faisaient déjà générer de larges pans de code par l'IA ; Veracode, en testant des centaines de modèles, a mesuré que **45 % du code généré tombe dans le Top 10 de l'OWASP** ; plusieurs études donnent **un taux de vulnérabilités environ 2,74 fois supérieur** à celui du code écrit à la main. Des équipes ont noté qu'après l'adoption de l'assistance par IA, la vitesse de commit a triplé voire quadruplé, et que les alertes de sécurité mensuelles sont passées d'environ 1 000 à plus de 10 000 en six mois. La vitesse est réelle, la dette aussi — sauf que la dette ne se solde pas le jour de la livraison : elle frappe à votre porte au septième mois.
...
Les progrès de la génération de code résolvent l'« **écrire plus vite** ». Or le problème de Mingxiang n'a jamais été d'écrire trop lentement — au contraire, c'était d'écrire trop vite : un système en deux jours, des modifications jaillissant à trois ou quatre fois la vitesse humaine. Le goulot est du côté « **comprendre et assumer** », et il ne s'améliore pas linéairement avec la capacité de génération. Un modèle plus puissant génère plus de code, plus vite — **donc accumule plus vite des implémentations que personne n'a lues** — et cette courbe d'alertes de sécurité passant de 1 000 à 10 000 est précisément la brèche ouverte par « la génération accélère, la compréhension et la revue ne suivent pas ». La revue par IA peut aider à passer un coup de balai, mais « ce que cette logique métier *devrait* être », elle ne peut en donner de réponse certaine, car le juste et le faux n'existent que dans le contexte métier, pas dans le code.
...
- **La gestion des risques** paie en incidents : ce calcul erroné qui a failli remonter au grand livre a été intercepté, mais pas forcément le suivant. Un taux de vulnérabilités x2,74, des alertes décuplées : tôt ou tard, l'une d'elles passera.
