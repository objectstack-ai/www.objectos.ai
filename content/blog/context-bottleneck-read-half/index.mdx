...
**Inferred context.** A [knowledge graph](/en/glossary/knowledge-graph/) learned continuously from the exhaust of the business — dashboards, queries, lineage, table descriptions, plus tickets, chats, documents and mail through dozens of connectors — with the resulting knowledge ranked by authority and usage. Databricks' Genie Ontology is the clearest expression of this shape.
