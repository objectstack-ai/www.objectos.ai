...
**En resumen:** la forma correcta de poner AI sobre tu CRM es leer primero clientes, oportunidades y notas bajo permisos, pasar luego del análisis solo lectura a las sugerencias y solo después a la ejecución controlada; no esquivar el CRM con una herramienta aparte.
...
![Diagrama conceptual](./customer-object-graph.webp)
