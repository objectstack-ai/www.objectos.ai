...
const zhHans: HomeCopy = {
  ...
  solutionsKicker: '典型场景',
  solutionsTitle: ['先解决一个真实问题，', '再逐步连接整个业务'],
  solutionLink: '探索相关内容',
  solutions: [
    { title: '智能 CRM', copy: '让客户信息、跟进记录与业务动作成为 AI 可以理解和执行的统一上下文。' },
...
const en: HomeCopy = {
  ...
  solutionsKicker: 'Common starting points',
  solutionsTitle: ['Solve one real problem first,', 'then connect the wider business'],
  solutionLink: 'Explore related content',
  solutions: [
    { title: 'Intelligent CRM', copy: 'Give AI a unified context for customer data, interactions, and the actions that move work forward.' },
...
const ja: HomeCopy = {
  ...
  solutionsKicker: '代表的な活用例',
  solutionsTitle: ['一つの現実的な課題から始め、', '業務全体へ広げる'],
  solutionLink: '関連記事を見る',
  solutions: [
    { title: 'インテリジェント CRM', copy: '顧客データ、やり取り、業務アクションを AI が理解・実行できる統一コンテキストにします。' },
...
const de: HomeCopy = {
  ...
  solutionsKicker: 'Typische Einstiegspunkte',
  solutionsTitle: ['Zuerst ein echtes Problem lösen,', 'dann das gesamte Geschäft verbinden'],
  solutionLink: 'Verwandte Inhalte',
  solutions: [
    { title: 'Intelligentes CRM', copy: 'Schaffen Sie einen einheitlichen Kontext für Kundendaten, Interaktionen und nächste Aktionen.' },
...
const es: HomeCopy = {
  ...
  solutionsKicker: 'Casos habituales',
  solutionsTitle: ['Resuelve primero un problema real,', 'después conecta todo el negocio'],
  solutionLink: 'Explorar contenido relacionado',
  solutions: [
    { title: 'CRM inteligente', copy: 'Ofrece a la AI un contexto unificado para datos de clientes, interacciones y acciones comerciales.' },
...
const fr: HomeCopy = {
  ...
  solutionsKicker: 'Points de départ',
  solutionsTitle: ['Résolvez d’abord un problème réel,', 'puis connectez toute l’entreprise'],
  solutionLink: 'Explorer les contenus associés',
  solutions: [
    { title: 'CRM intelligent', copy: 'Donnez à l’AI un contexte unifié pour les données clients, interactions et actions métier.' },
...
const ko: HomeCopy = {
  ...
  solutionsKicker: '대표 활용 사례',
  solutionsTitle: ['실제 문제 하나부터 해결하고,', '전체 업무로 연결을 확장하세요'],
  solutionLink: '관련 콘텐츠 보기',
  solutions: [
    { title: '지능형 CRM', copy: '고객 데이터, 상호작용과 업무 작업을 AI가 이해하고 실행할 수 있는 통합 맥락으로 만듭니다.' },
