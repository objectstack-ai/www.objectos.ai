---
title: "How AI Agents Stay Inside Enterprise Permission Boundaries: Identity, Approval, and Audit"
...
**The short version:** A production-ready AI agent must behave like a controlled user — inherit the user's identity, enforce permissions down to objects, records, fields, and actions, go read-only before acting, require approval and rollback for high-risk actions, and log every step. The only question: controlled user, or shadow admin?
