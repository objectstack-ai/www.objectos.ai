---
title: "Metadata, Not Code Generation: What Actually Makes an App AI-Native"
description: "Code generation can speed up prototypes, but enterprise applications need a metadata runtime where objects, fields, relationships, views, permissions, workflows, actions, and Agent tools are governed together."
...
**The short version:** An AI-native app isn't a pile of generated code; it's generated metadata — objects, permissions, flows, and agent tools under one governed runtime. Code runs; metadata is what stays changeable and governable.
...
## Readers care less about code than about whether the system can change
