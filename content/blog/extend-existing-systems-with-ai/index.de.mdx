...
Dieser Ablauf funktioniert **heute** mit Datasources, objektbezogenem Routing, ObjectQL Pushdown und der AI-Agent-Schicht. Eine reichere turn-key Federation mit Schema-Import, Bindung an externe Schemas und eingebauten Write-Safety-Gates ist in [ADR-0015](https://github.com/objectstack-ai/framework/blob/main/docs/adr/0015-external-datasource-federation.md) in aktiver Gestaltung.
