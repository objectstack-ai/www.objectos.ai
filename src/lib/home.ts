...
const en: HomeCopy = {
  ...
  eyebrow: 'Open-source · AI-native app platform',
...
const ja: HomeCopy = {
  ...
  eyebrow: 'オープンソース · AI-native アプリ基盤',
  ...
  primaryCta: 'GitHub でスター',
  secondaryCta: 'ライブデモを試す',
...
const de: HomeCopy = {
  ...
  eyebrow: 'Open Source · AI-native App-Plattform',
  ...
  primaryCta: 'Star auf GitHub',
  secondaryCta: 'Live-Demo testen',
...
const es: HomeCopy = {
  ...
  eyebrow: 'Código abierto · Plataforma de apps AI-native',
...
const fr: HomeCopy = {
  ...
  eyebrow: 'Open source · Plateforme d’applications AI-native',
