...
| --- | --- | --- | --- |
| **Microsoft Fabric IQ** | Ontology item, Graph, Data Agent, Operations Agent | Ignite 2025 (Nov 18–21, 2025) | Public preview |
| **Databricks Unity Catalog** | Business Semantics / metric views, GA + open sourcing | Data + AI Summit 2026 (June 2026) | GA |
| **Snowflake** | Semantic View Autopilot, GA | Feb 3, 2026 | GA |
| **Palantir Foundry** | SuperRepo beta — Ontology-as-code | Week of Aug 3, 2026 | Beta |
...
| **Permissions** | Item-level, share/edit | Inherited from UC | Public/private fields | Object + dynamic security |
| **Agent interface** | Ontology MCP (preview) | Genie, AI/BI | Cortex Analyst, MCP | Ontology MCP, OSDK |
| **Definition portable** | *Unverified* | Spark OSS, OSI-ready | YAML spec | Git monorepo, Foundry-bound |
