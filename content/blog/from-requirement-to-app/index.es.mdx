...
**En resumen:** recorre un escenario de ticket de reparación y observa cómo objetos, campos, vistas, permisos, acciones, flujos, API y herramientas de agente salen todos de una misma pieza de metadatos: esa es la diferencia entre generar una aplicación ejecutable y volcar código de un solo uso.
