...
description: "Ein Projekt erntete am Demo-Tag tosenden Applaus und wurde vier Monate später stillschweigend abgeschaltet. Getötet hat es nicht das Modell, sondern eine Frage der Rechtsabteilung. 88 % der Agent-Piloten kommen über den PoC nicht hinaus, 95 % erzielen keinen Return – ein stärkeres Modell hilft kaum, denn 80 % der Arbeit sind Daten und Governance. Dieser Artikel zerlegt, an welchen vier Schichten die Piloten sterben, und vergleicht, was jene 12 %, die es in die Produktion schafften, richtig gemacht haben."
