...
const en: HomeCopy = {
  title: 'ObjectOS · Open-source AI-native app platform',
  description: 'ObjectOS is the open-source, AI-native platform for building real business applications. Describe what you need and AI builds the data model, UI, workflows, and permissions — on a database you own. Self-host it, or run it in the cloud.',
  eyebrow: 'AI-native app platform',
  hero: ['Build it with AI.', 'Run it with AI agents.'],
  heroLead: 'ObjectOS is the open-source, AI-native app platform. AI builds the whole application — data model, UI, workflows, and permissions — and AI agents then query your data and run it within user permissions. On a real database you own. Self-host it, or run it in our cloud.',
  primaryCta: 'Get started',
  secondaryCta: 'See how it works',
  proof: [['Open source', 'Self-host, own your data'], ['AI-built', 'Real apps, not just spreadsheets'], ['Governed', 'Permissions and audit built in']],
  ...
  aiCopy: 'ObjectOS turns objects, fields, workflows, permissions, and actions into declarative metadata that AI reads and changes through governed tools. The open-source edition is bring-your-own-AI: your coding agent authors metadata as source you review as a diff, and any MCP client queries your data. The in-app Build and Ask assistants — natural-language build and data chat inside the product — run on Cloud and Enterprise.',
  aiItems: [
    { title: 'AI Builder', copy: 'Cloud & Enterprise: build in natural language — the in-app Builder generates objects, fields, views, workflows, and permissions, with structural changes routed for approval. On open source, your own coding agent authors the same metadata as source you review as a diff.' },
    { title: 'AI Ask', copy: 'Cloud & Enterprise: ask your data inside the product — query business objects, analyze context, and trigger actions within the signed-in user’s permissions. On open source, query the same objects through MCP with your own AI.' },
    { title: 'Tools / MCP', copy: 'Every edition, bring-your-own-AI: @objectstack/mcp exposes objects, actions, and queries as governed, permission-bounded tools for Claude, Cursor, any MCP client, or a local model.' },
  ],
