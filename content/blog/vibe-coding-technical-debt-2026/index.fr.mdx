...
Ces quelques dizaines de lignes ne sont pas « une interface qu'il reste à implémenter », **elles sont le système même**. Le runtime ouvert ObjectStack la lit et en dérive automatiquement les tables de données, les API, l'interface, ainsi que les outils gouvernés appelables par l'agent ; les permissions et les flux de validation sont eux aussi des déclarations rattachées à elle, pas des jugements écrits à la main.
