...
4. Which declared integration keys are actually enforced, and which are decoration? Ask for one example of a key the vendor removed because nothing read it. The answer is revealing either way.
