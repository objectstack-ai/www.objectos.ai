---
title: "Hör auf, deiner KI den Stack einzubläuen – gib ihr Regeln, die „governbare Apps“ generieren"
description: "Jedes Team gibt seinem Coding-Agent heute eine AGENTS.md oder .cursor/rules, doch neun von zehn Regeln steuern nur den Code-Stil – sie machen den Output „konform“, nicht „governbar“. Hier steht, warum die Regeldatei deines Agents dein eigentliches Architekturdokument ist."
...
Anders gesagt: **Sobald das Codeschreiben an die KI übergeben ist, wird die Regeldatei vom „Code-Styleguide" zur „Architektur- und Governance-Vorgabe"** – denn sie ist einer der wenigen Orte, an denen sich die Vorgabe **im Moment der Generierung** einschleusen lässt. Ist der Code erst einmal generiert, sind nachträglich ergänzte Berechtigungen und Audits Nacharbeit; die Regeldatei dagegen ist der einzige Hebel, der „schon vor der Generierung vorbeugen" kann. Sie weiter für die Einrückung einzusetzen heißt, das Lenkrad als Hutablage zu benutzen.

## Schreib „Governbarkeit" in die Regeln, statt sie nachzureichen

Governance nachzureichen ist der derzeit häufigste und teuerste Fehler: Erst den Agent generieren lassen, dann nachträglich Berechtigungen prüfen, Audit ergänzen, Freigaben einbauen – genau die Governance-Nacharbeit, die [im Artikel zu den 88 % gescheiterten Pilotprojekten](/de/blog/why-ai-agent-pilots-fail-four-layers/) beschrieben ist und dort acht Zehntel des Aufwands ausmacht. Bei jeder generierten App fällt sie erneut an, und nach der Skalierung kann sich diese Rechnung niemand mehr leisten.
...
Die Antwort ist genau jenes Schwungrad, das [der Artikel zur offenen semantischen Schicht](/de/blog/enterprise-ontology-race-open-vs-closed/) begründet hat – **ein Agent generiert das, was er gesehen hat, und was er gesehen hat, ist das Offene, vollständig Dokumentierte, in den Trainingsdaten massenhaft Vorhandene**. Das proprietäre Format einer geschlossenen Plattform hat das Modell nie gelernt, und egal wie du die Regeln schreibst, es generiert es nicht sauber. ObjectStack dagegen ist ein offenes Protokoll unter Apache 2.0, und das verschafft dem „den Agent es richtig schreiben lassen" drei reale Voraussetzungen:
