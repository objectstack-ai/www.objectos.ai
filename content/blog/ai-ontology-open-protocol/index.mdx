---
title: "Enterprise AI Ontology: Why the Semantic Layer Should Be an Open Protocol"
description: "Palantir proved that AI needs a governed semantic layer to enter the enterprise. As AI writes software and agents choose the stack, it is time to rethink which layer should be open."
