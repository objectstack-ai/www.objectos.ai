  ...
  values: ['mrr'],
    ...
    sections: [
      ...
      },
      {
        ...
        title: '点选组装，存成元数据',
        copy:
          '仪表盘和报表在开源 ObjectStack 控制台的设计器中打开——你点出来的东西，存下来就是 Agent 写的那种可审阅定义。',
        items: [
          {
            title: '仪表盘设计器',
    ...
    faqs: [
      ...
      {
        question: '仪表盘和报表设计器在开源 ObjectStack 里吗？',
        answer:
          '在。小部件式仪表盘设计器、分节式报表设计器、下钻、聚合、时间序列、漏斗与语义数据集都是开源 ObjectStack 运行时的一部分，权限执行与平台其他部分完全一致。',
      },
    ],
