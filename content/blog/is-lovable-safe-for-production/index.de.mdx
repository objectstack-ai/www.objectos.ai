---
title: "Ist Lovable produktionsreif? Das Problem der unsichtbaren Zugriffskontrolle"
description: "Lovable lässt einen Nicht-Entwickler aus einem Satz eine Full-Stack-App ausliefern — doch die Zugriffskontrolle landet vergraben in generiertem Code, den er nicht lesen kann. Ein Scan von 4.000+ Apps fand 170+, die Live-PII leaken. „Es läuft“ heißt nicht „es ist sicher“."
...
**TL;DR:** Lovable ist der schnellste Weg für einen Nicht-Entwickler, eine echte, monetarisierbare Full-Stack-App auszuliefern. Die Gefahr ist konkret und nachweisbar: Die Zugriffskontrolle, die entscheidet, wer die Daten deiner Nutzer lesen darf, wird als Supabase-Row-Level-Security-SQL generiert — von einer KI, für jemanden, der per Definition kein SQL lesen kann — und das häufigste generierte Muster, `using (true)`, *sieht aus* wie eine Sicherheitsrichtlinie, schützt aber nichts. Ein Frontend-Filter `.eq('owner', user.id)`, der die Demo korrekt verhalten lässt, ist eine **Bequemlichkeit der Anfrage, keine Sicherheitsgrenze**. Ein Scan von 4.000+ Lovable-Apps fand 2.000+ Schwachstellen, 400+ exponierte Secrets und **175, die Live-PII leaken**; CVE-2025-48757 exponierte 170+ Apps durch exakt diese Fehlerklasse. „Es läuft“ und „es ist sicher“ sind verschiedene Behauptungen, und die Person, die ausliefert, kann sie nicht auseinanderhalten.
...
## Die Zahl, die 170 Leaks erklärt: die Verifikations-Asymmetrie
...
Wenn die Baukosten auf null kollabieren, die Verifikationskosten aber bei Experten-Stunden bleiben, ist das rationale Verhalten eines Nicht-Experten, **die Verifikation zu überspringen** — weil er sie nicht durchführen kann und die App fertig *aussieht*. Multipliziere das über eine Population und du bekommst nicht ein paar unglückliche Leaks; du bekommst 175 Apps, die in einem einzigen Scan Live-PII leaken. Die Zahl 170+ ist kein Lovable-Qualitätsproblem. Sie ist das, was die Verifikations-Asymmetrie im großen Maßstab produziert, mit jedem Tool, das Nicht-Experten Zugriffskontrolle generieren lässt, die sie nicht lesen können.
