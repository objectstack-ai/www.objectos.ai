...
| **Databricks Unity Catalog** | Business Semantics, GA — geregelte Metric Views und Agent-Metadaten einmal auf der Datenebene definiert, die Kernimplementierung wird in Apache Spark quelloffen gestellt | Data + AI Summit, Juni 2026 |
