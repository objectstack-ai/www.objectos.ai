---
title: "Connecting AI to Legacy Manufacturing Systems: Start with Reports and Work Orders, Not a New ERP"
description: "Manufacturing systems are old, heavy, and hard to replace. A practical AI path connects existing systems and starts with reports, work orders, and exception analysis."
...
**The short version:** Manufacturing doesn't need to replace its ERP or MES to adopt AI — start at two entry points, reports and work orders, layer an AI-readable business structure over legacy systems, and save automation for last. The key to adoption is boundaries, not the model.
...
![Concept diagram](./factory-ai-layer.webp)
